        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-4 pl-2">
              <li>
                <Link href="/" className="text-gray-400 hover:text-white text-sm">Image Vectorize</Link>
              </li>
              <li>
                <Link href="/contactUs" className="text-gray-400 hover:text-white text-sm">Contact Us</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 pl-2">
              ...
              <li>
                <Link href="#" className="text-gray-400 hover:text-white text-sm">Terms &amp; Conditions</Link>
              </li>
            </ul>
          </div>
        </div>
